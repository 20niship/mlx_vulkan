...
template <class T, size_t N, ComputeBackend Backend> array<T, 1, Backend> sum(const array<T, N, Backend>& a) { return array<T, 1, Backend>(make_node<Backend>(OpType::Sum, Shape{1}, a.dtype(), {a.node()})); }

template <class T, size_t N, ComputeBackend Backend> array<T, 1, Backend> reduce_max(const array<T, N, Backend>& a) { return array<T, 1, Backend>(make_node<Backend>(OpType::ReduceMax, Shape{1}, a.dtype(), {a.node()})); }

template <class T, size_t N, ComputeBackend Backend> array<T, 1, Backend> argmax(const array<T, N, Backend>& a) { return array<T, 1, Backend>(make_node<Backend>(OpType::ArgMax, Shape{1}, a.dtype(), {a.node()})); }

template <class T, size_t N, ComputeBackend Backend> array<T, 1, Backend> argmin(const array<T, N, Backend>& a) { return array<T, 1, Backend>(make_node<Backend>(OpType::ArgMin, Shape{1}, a.dtype(), {a.node()})); }
